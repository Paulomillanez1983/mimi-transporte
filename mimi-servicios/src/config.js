...
export const appConfig = {
  ...
  categories: [
    { id: "servicio-domestico", code: "SERVICIO_DOMESTICO", name: "Servicio doméstico", description: "Ayuda general para el hogar.", aliases: ["domestico", "hogar", "casa"] },
    ...
    { id: "plomeria", code: "PLOMERIA", name: "Plomería", description: "Cañerías, pérdidas, grifería, baños y urgencias simples.", aliases: ["plomero", "canos", "fuga", "perdida de agua"] },
    { id: "electricidad", code: "ELECTRICIDAD", name: "Electricidad", description: "Instalaciones, reparaciones y revisiones eléctricas.", aliases: ["electricista", "luz", "enchufe", "cortocircuito"] },
    ...
    { id: "instalacion-aire", code: "INSTALACION_AIRE", name: "Instalación de aire", description: "Instalación, mantenimiento y revisión de aires acondicionados.", aliases: ["aire acondicionado", "split", "refrigeracion", "ac"] },
    { id: "refrigeracion", code: "REFRIGERACION", name: "Refrigeración", description: "Heladeras, freezers, cámaras y equipos de frío.", aliases: ["heladera", "freezer", "frio"] },
    ...
    { id: "colocacion-ceramicos", code: "COLOCACION_CERAMICOS", name: "Colocación de cerámicos", description: "Colocación, reparación y terminaciones con cerámicos.", aliases: ["ceramicos", "azulejos", "colocar ceramicos"] },
    { id: "cerrajeria", code: "CERRAJERIA", name: "Cerrajería", description: "Cerraduras, llaves, aperturas y cambios.", aliases: ["cerrajero", "llave", "cerradura"] },
    { id: "carpinteria", code: "CARPINTERIA", name: "Carpintería", description: "Muebles, puertas, arreglos y trabajos en madera.", aliases: ["carpintero", "madera", "mueble"] },
    { id: "albanileria", code: "ALBANILERIA", name: "Albañilería", description: "Arreglos, pequeñas obras y mantenimiento.", aliases: ["albanil", "obra", "pared"] },
    { id: "jardineria", code: "JARDINERIA", name: "Jardinería", description: "Corte, poda, limpieza y mantenimiento de espacios verdes.", aliases: ["jardinero", "poda", "pasto"] },
    ...
    { id: "peluqueria", code: "PELUQUERIA", name: "Peluquería", description: "Corte, peinado, color y servicios personales.", aliases: ["peluquero", "corte", "peinado"] },
    { id: "manicuria", code: "MANICURIA", name: "Manicuría", description: "Manos, uñas, esmaltado y belleza personal.", aliases: ["unas", "esmaltado", "nails"] },
    { id: "pestanas", code: "PESTANAS", name: "Pestañas", description: "Pestañas, lifting, extensiones y servicios relacionados.", aliases: ["pestanas", "pestañas", "lifting", "extensiones"] },
    ...
    { id: "cuidado-adultos", code: "CUIDADO_ADULTOS", name: "Cuidado de adultos", description: "Acompañamiento y cuidado de personas mayores.", aliases: ["cuidador", "ancianos", "adultos mayores", "cuy", "cui"] },
    ...
    { id: "acompanamiento-domiciliario", code: "ACOMPANAMIENTO_DOMICILIARIO", name: "Acompañamiento domiciliario", description: "Acompañamiento no médico y asistencia cotidiana a coordinar.", aliases: ["acompanante", "acompanamiento", "domiciliario", "adultos mayores"] },
    ...
    { id: "psicologia", code: "PSICOLOGIA", name: "Psicología", description: "Orientacion y acompanamiento psicologico con profesionales independientes.", aliases: ["psicologo", "psicologa", "terapia", "ansiedad", "emocional", "salud mental"] },
    { id: "nutricion", code: "NUTRICION", name: "Nutrición", description: "Consultas y orientacion nutricional con profesionales independientes.", aliases: ["nutricionista", "alimentacion", "dieta", "plan alimentario"] },
    { id: "kinesiologia", code: "KINESIOLOGIA", name: "Kinesiología", description: "Rehabilitacion, movilidad y sesiones de kinesiologia.", aliases: ["kinesiologo", "fisio", "rehabilitacion", "dolor muscular"] },
    { id: "abogacia", code: "ABOGACIA", name: "Abogacía", description: "Consultas legales y orientacion profesional independiente.", aliases: ["abogado", "abogada", "legal", "contrato", "laboral", "familia"] },
